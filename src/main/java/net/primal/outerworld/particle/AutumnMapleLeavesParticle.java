...
public class AutumnMapleLeavesParticle extends SpriteBillboardParticle {

    private float field_43369;
    private final float field_43370;
    private final float field_43371;

    protected AutumnMapleLeavesParticle(ClientWorld world, double xCoord, double yCoord, double zCoord,
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType type, ClientWorld clientWorld,
            ...
            return new AutumnMapleLeavesParticle(clientWorld, x, y, z, velocityX, velocityY, velocityZ, this.spriteProvider);
        }
    }
}